...
**Legend:** (A) Heatmap displays a representative set of association
effect sizes between five categories of traits (x-axis) and deletions
and duplications aggregated by whole-body cell types (y-axis). Traits
are categorized on the x-axis, and gene sets are listed on the y-axis
with annotations on the right. Blue and red intensity reflects negative
and positive effect sizes. Asterisks (*) indicate FDR-significant
associations (two-sided t-test from multiple linear regression; 172 gene
sets X 43 traits X 2 CNV types = 14,792 tests). A representative subset
is shown (complete heatmaps in Figs. S28-S29). (B-C) Summary of variant
association differences across cell types. (B) Whole-Body Comparison:
Differences in aggregate association/enrichment levels across variant
types for all cell type gene sets. (C) Higher pleiotropy in brain cell
types: Proportion of significant trait associations for brain and
non-brain cell type gene sets. In both panels, data are presented as the
aggregate statistical proportion of significant enrichments ± standard
error. Statistics are derived from gene sets rather than individual
sample observations. For these panels, n = 81 whole-body cell type gene
sets (n = 7 brain, n = 74 non-brain). No technical or biological
replicates are utilized. Asterisks (*) denote FDR-adjusted statistical
significance (two-sided Pearson’s Chi-squared test). (D) Pearson
correlation of gene-set effect sizes between AoU and UKBB. The two-sided
Pearson correlation test demonstrates replication for both deletions (r
= 0.70, p = 3.74e-13) and duplications (r = 0.41, p = 1.20e-04). The
solid line denotes the linear regression fit, with shaded regions
representing the 95% confidence intervals, alongside a dashed line
representing perfect concordance (y = x). (E) Discovery power and
cross-cohort replication. Per-trait concordance of 81 gene-set effect
sizes (BMI, Heart Rate, Platelet Count, Standing Height) vs. number of
UKBB FDR-significant gene sets (Pearson correlation test, r = 0.75, p =
3.30e-02). Abbreviations: HDL, high-density lipoprotein; HbA1c, glycated
haemoglobin; BMD, bone mineral density; BMI, body mass index; EA,
...
| Geneset_Type | Type1 | Type2 |                      p_value                      | statistic  | estimate_prop_Type1 | estimate_prop_Type2 |                   p_value_fdr                    |
|:------------:|:-----:|:-----:|:-------------------------------------------------:|:----------:|:-------------------:|:-------------------:|:------------------------------------------------:|
|     HPA      |  SNP  |  Del  | 0.00000000000000000000000000000000000000000000618 | 197.840004 |      0.0399610      |      0.1418318      | 0.0000000000000000000000000000000000000000000556 |
|     HPA      |  SNP  |  Dup  | 0.00000000000000000000000000000003220000000000000 | 139.619410 |      0.0399610      |      0.1208728      | 0.0000000000000000000000000000000967000000000000 |
|     HPA      |  Del  |  Dup  | 0.01065306499999999975680786690190871013328433037 |  6.522292  |      0.1418318      |      0.1208728      | 0.0119846980000000002258842002333949494641274214 |

Pairwise Proportion Comparisons (HPA CellType81)
...
|:----:|:------------:|:--------:|:--------:|:------------:|:---------:|:------------------:|:------------------:|:------------:|
| Del  |     HPA      |  Brain   | NonBrain | 0.0036680650 | 8.441238  |     0.1993355      |     0.1363922      | 0.0055020970 |
| Dup  |     HPA      |  Brain   | NonBrain | 0.2577818870 | 1.280630  |     0.1428571      |     0.1187932      | 0.3314338550 |
| SNP  |     HPA      |  Brain   | NonBrain | 0.0000000329 | 30.527802 |     0.1052632      |     0.0337838      | 0.0000000592 |

Brain vs Non-Brain Proportion Comparisons (HPA CellType81)
...
|:------------:|:-----:|:--------:|:---------:|:------------:|:---------:|:---------:|:---------:|:----------:|
|   SC_HPA81   |  BMI  |   DEL    |   0.700   |  3.741e-13   |   0.988   |  -0.020   |   0.489   |     81     |
|   SC_HPA81   |  BMI  |   DUP    |   0.414   |  1.198e-04   |   0.639   |   0.003   |   0.172   |     81     |
...
|:---------------:|:---------:|:------------:|:---------:|:---------:|:---------:|:-------------:|
| 4 Mutual Traits |   0.759   |  2.909e-02   |  0.0177   |  0.1282   |   0.576   |       8       |
